      ...
      <Pressable style={styles.card} onPress={() => onPress(item)}>
        <View style={styles.cardTop}>
          <View style={[styles.programBadge, { backgroundColor: programStyle.bg }]}>
            <Text style={[styles.programText, { color: programStyle.fg }]}>
              {item.program}
            </Text>
          </View>
...
export const QnATab = () => {
  ...
  const toggleProgram = useCallback(
    (prog: string) => {
      setQnaPrograms(
        qnaPrograms.includes(prog)
          ? qnaPrograms.filter((p) => p !== prog)
          : [...qnaPrograms, prog],
      );
    },
  ...
  const renderItem = useCallback(
    ({ item }: { item: QnaQuestion }) => (
      <QnaCard item={item} onPress={handleSelectItem} />
    ),
    [handleSelectItem],
  );
          ...
          return (
            ...
            >
              <Text
                style={[
                  styles.chipText,
                  { color: active ? ps.fg : colors.mutedForeground },
                ]}
              >
                {PROGRAM_LABELS[prog]}
              </Text>
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              Try a broader keyword or clear your query.
            </Text>
          </View>
        }
      />
          ...
          <Pressable style={styles.vpnOverlay} onPress={dismissVpn}>
            <Pressable style={styles.vpnSheet}>
              ...
              <Text style={styles.vpnBody}>
                A VPN is active. Image downloads may be slower or blocked. Download images
                anyway?
              </Text>
